...
// За прохождение испытаний (каждое испытание это один итем) предусмотрены лвл поинты, эта функция сравнивает даты и начисляет их + обновляет UI если текущая дата больше
